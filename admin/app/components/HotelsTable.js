...
export function HotelsTable(props){
    ...
    return(
        ...
        <div className=" flex items-center justify-between gap-8">
          <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
            <Button className="flex items-center gap-3" size="sm">
              ...
              <Link href={'../hotels/new/'}>Add member</Link>  
            </Button>
          </div>
      ...
      <CardBody className="overflow-scroll px-0">
        <table className="mt-2 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {TABLE_ROWS.map(
              ({ _id,photos, name, type, city, cheapestPrice }, index) => {
                  ...
                  <tr key={name}>
                    ...
                    <td className={classes}>
                      <div className="flex items-center gap-3">
                        <Avatar src={photos[0] ? photos[0]: "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"} alt={'photo'} size="sm" />
