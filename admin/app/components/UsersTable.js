  ...
  return (
    ...
    <CardBody className="overflow-scroll px-0">
      <table className="mt-2 w-full min-w-max table-auto text-left">
        ...
        <tbody>
          {TABLE_ROWS.map(
            ({ _id,img, username, email, country, date }, index) => {
                ...
                <tr key={name}>
                  ...
                  <td className={classes}>
                    <div className="flex items-center gap-3">
                      <Avatar src={img ? img: "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"} alt={'photo'} size="sm" />
